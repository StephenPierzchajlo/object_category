...
#post1 <- draws(24)
abc_graph(draws(24), "Participant is guessing")
```
...
#post1 <- draws(31)
abc_graph(draws(31), "Guessing Threshold")
```
...
#post1 <- draws(40)
abc_graph(draws(40), "Participant Is Not Guessing")
```
...
```{r message=FALSE, warning=FALSE, echo=FALSE, fig.width=4, fig.height=4}
# Save file.
png(path.expand("../results/power_simulation_13.png"),
    units = "in", width = 4, height = 4, res = 300)
